...
🧑‍💻 Python Libraries:
python-telegram-bot: A Python wrapper for the Telegram Bot API 🛠️
...
An IP Lookup API key (you can use services like ipapi or any other provider you prefer) 🌐
⚙️ Installation
Clone this repo:
...
Open config.py .
Replace the placeholders with your Telegram bot token and IP Lookup API key.
Run the bot:
python GeoTrace.py
...
If you like this project, please give it a ⭐ on GitHub! Your support helps me a lot. Thank you! 🙏
